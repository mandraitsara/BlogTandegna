...
class StockForm(forms.Form):
     nombre = forms.CharField(widget=forms.NumberInput(attrs={"class":"form-control","min":"1","max":"100"}))
...
class ArticleForm(forms.Form):
    ...
    type = forms.ChoiceField(choices=optype, widget=forms.Select(attrs={'class':"form-control"}))
...
class ArticlePhotoForm(forms.Form):
        image1 = forms.FileField(widget=forms.FileInput(attrs={'class':'form-control','id':'file1','onchange':'return fileValidation()'}))
        image2 = forms.FileField(widget=forms.FileInput(attrs={'class':'form-control','id':'file2','onchange':'return fileValidation_1()'}))
        image3 = forms.FileField(widget=forms.FileInput(attrs={'class':'form-control','id':'file3','onchange':'return fileValidation_2()'}))
        image4 = forms.FileField(widget=forms.FileInput(attrs={'class':'form-control','id':'file4','onchange':'return fileValidation_3()'}))
